...
const projects = [
  {
    ...
    desc: 'My personal portfolio site built with React and TypeScript, featuring interactive particle animations, smooth scroll effects, and a clean Apple-inspired design.',
    color: '#e8e8ed',
    emoji: '🚀',
  ...
  {
    id: 2,
    title: 'LandVerify Platform',
    category: 'Web App',
    tags: ['React', 'Tailwind CSS', 'API Integration'],
    desc: 'A land verification platform designed to streamline property validation processes with a modern, professional UI and real API integration capabilities.',
    color: '#d1d1d6',
    emoji: '🏗️',
    github: 'https://github.com/mourice-dev',
    live: '#',
  },
  {
    ...
    desc: 'A practice project exploring React Router navigation, dynamic routing, and component-based architecture patterns.',
    color: '#c7c7cc',
    emoji: '🔗',
    github: 'https://github.com/mourice-dev/react-router-test',
    live: '#',
  },
]
