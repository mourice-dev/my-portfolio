...
const tools = [
  ...
  { name: 'TypeScript', icon: (
    <svg viewBox="0 0 24 24" className="w-8 h-8" fill="#1A1A1A"><path d="M1.125 0C.502 0 0 .502 0 1.125v21.75C0 23.498.502 24 1.125 24h21.75c.623 0 1.125-.502 1.125-1.125V1.125C24 .502 23.498 0 22.875 0zm17.363 9.75c.612 0 1.154.037 1.627.111a6.38 6.38 0 01-1.306.34v2.458a3.95 3.95 0 00-.643-.361 5.093 5.093 0 00-.717-.26 5.453 5.453 0 00-1.426-.2c-.3 0-.573.028-.819.086a2.1 2.1 0 00-.623.242c-.17.104-.3.229-.393.374a.888.888 0 00-.14.49c0 .196.053.373.156.529.104.156.252.304.443.444s.42.276.69.394.57.24.907.348c.481.168.922.36 1.325.578.404.218.753.476 1.048.771.295.296.526.64.69 1.033.164.393.246.853.246 1.38 0 .703-.138 1.288-.415 1.756a3.087 3.087 0 01-1.095 1.109 4.602 4.602 0 01-1.563.587 8.147 8.147 0 01-1.822.2c-.656 0-1.288-.067-1.895-.2a6.272 6.272 0 01-1.63-.578v-2.598c.263.199.538.376.826.532.287.156.586.29.895.4a5.51 5.51 0 001.825.3c.283 0 .545-.033.785-.1a1.72 1.72 0 00.58-.257c.16-.107.281-.243.362-.406a1.13 1.13 0 00.119-.512 1.06 1.06 0 00-.167-.579 1.87 1.87 0 00-.492-.467 5.17 5.17 0 00-.806-.422c-.322-.14-.699-.295-1.13-.463a9.588 9.588 0 01-1.219-.583 4.26 4.26 0 01-.979-.754 3.2 3.2 0 01-.648-1.02c-.155-.39-.233-.846-.233-1.367 0-.644.145-1.21.434-1.697a3.553 3.553 0 011.162-1.168 5.26 5.26 0 011.664-.68 7.97 7.97 0 011.908-.224zm-9.893.5h5.066v2.006H10.6v8.744h-2.41v-8.744H5.196V10.25z"/></svg>
  )},
  { name: 'Java', icon: (
    <svg viewBox="0 0 24 24" className="w-8 h-8" fill="#1A1A1A">
      <path d="M4 19h16v2H4v-2zm12-9c.34-.34.5-.78.5-1.25V6H6v2.75c0 .47.16.91.5 1.25l3 3c.34.34.78.5 1.25.5h2.5c.47 0 .91-.16 1.25-.5l3-3zM2 9v1c0 2.21 1.79 4 4 4h1v2c0 1.1.9 2 2 2h6c1.1 0 2-.9 2-2v-2h1c2.21 0 4-1.79 4-4V9h-2v1c0 1.1-.9 2-2 2h-1.09c-.27-.58-.69-1.07-1.21-1.41L13.25 9H16V7h-3.25c-.2-.48-.52-.9-.94-1.22L11 5h2V3h-4v2h1.09c.27.58.69 1.07 1.21 1.41L9.25 8H6V6H4v3H2z"/>
    </svg>
  )},
  { name: 'PHP', icon: (
    <svg viewBox="0 0 24 24" className="w-8 h-8" fill="#1A1A1A">
      <path d="M3 6h3.5a2.5 2.5 0 010 5H3v7H1V6zm2 3.5h1.5a.75.75 0 000-1.5H5v1.5zm4.5-3.5h2v4.5h3V6h2v12h-2v-5.5h-3V18h-2V6zm9.5 0h3.5a2.5 2.5 0 010 5H19v7h-2V6zm2 3.5h1.5a.75.75 0 000-1.5H19v1.5z"/>
    </svg>
  )},
  { name: 'React', icon: (
  ...
  { name: 'Socket.io', icon: (
    <svg viewBox="0 0 24 24" className="w-8 h-8" fill="#1A1A1A">
      <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 22c-5.523 0-10-4.477-10-10S6.477 2 12 2s10 4.477 10 10-4.477 10-10 10zm1.86-14.77l-4.59 5.82a.5.5 0 00.39.81h2.84l-.99 4.37a.5.5 0 00.83.47l4.59-5.82a.5.5 0 00-.39-.81h-2.84l.99-4.37a.5.5 0 00-.83-.47z"/>
    </svg>
  )},
  { name: 'MySQL', icon: (
  ...
  { name: 'PostgreSQL', icon: (
    <svg viewBox="0 0 24 24" className="w-8 h-8" fill="#1A1A1A">
      <path d="M12 2C7.58 2 4 3.79 4 6v12c0 2.21 3.58 4 8 4s8-1.79 8-4V6c0-2.21-3.58-4-8-4zm0 2c3.87 0 6 1.34 6 2s-2.13 2-6 2-6-1.34-6-2 2.13-2 6-2zm6 14c0 .66-2.13 2-6 2s-6-1.34-6-2v-3.15c1.47.73 3.6 1.15 6 1.15s4.53-.42 6-1.15V18zm0-4.15c-1.47.73-3.6 1.15-6 1.15s-4.53-.42-6-1.15V10.7c1.47.73 3.6 1.15 6 1.15s4.53-.42 6-1.15v3.15z"/>
    </svg>
  )},
  { name: 'MongoDB', icon: (
    <svg viewBox="0 0 24 24" className="w-8 h-8" fill="#1A1A1A">
      <path d="M17.193 11.232c-.854-3.662-3.143-6.525-4.417-8.03a.762.762 0 00-1.127 0c-1.274 1.505-3.563 4.368-4.417 8.03-1.07 4.582.49 8.243 4.316 9.585a1.233 1.233 0 001.056 0c3.826-1.342 5.385-5.003 4.316-9.585zm-4.943 7.94v-13.88c.84 1.22 2.37 3.53 2.92 6.55.77 4.23-.74 6.77-2.92 7.33z"/>
    </svg>
  )},
  { name: 'HTML5', icon: (
  ...
  { name: 'Postman', icon: (
    <svg viewBox="0 0 24 24" className="w-8 h-8" fill="#1A1A1A">
      <path d="M12.33 2.08a.67.67 0 00-.66 0L2.83 7.18a.67.67 0 00-.33.58v10.18c0 .25.13.48.33.58l8.84 5.1a.67.67 0 00.66 0l8.84-5.1a.67.67 0 00.33-.58V7.76a.67.67 0 00-.33-.58l-8.84-5.1zM12 3.86l7.5 4.33v8.66L12 21.18l-7.5-4.33V8.19L12 3.86zM9.5 8a2.5 2.5 0 100 5 2.5 2.5 0 000-5zm5 3a2.5 2.5 0 100 5 2.5 2.5 0 000-5z"/>
    </svg>
  )},
  { name: 'VS Code', icon: (
