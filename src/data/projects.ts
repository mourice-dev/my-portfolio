...
import weathAppImage from "../assets/weath app.png";
...
export const projects = [
  {
    ...
    description:
      "A web app that allows users to quickly create polished, professional resumes without formatting hassles — just fill in your details and download.",
    ...
    image: resumeImage,
    github: "https://github.com/mourice-dev/ResumeGeneretor-react.git",
  ...
  },
  {
    ...
    description:
      "A complete e-commerce platform built from the ground up — handling products, carts, user sessions, and secure checkout flows.",
    client: "Personal Project",
    year: "2025",
  ...
  },
  {
    ...
    headline: "A modern e-commerce for shoes",
    description:
      "A modern e-commerce website for shoes, built with React and Tailwind CSS.",
    client: "Personal Project",
    year: "2024",
    ...
    whatIdid: ["React", "TypeScript", "Tailwind CSS"],
    image: shoeEcommerceImage,
    github: "https://github.com/mourice-dev/-e-commerce-shoes-tailwindcss-typescript.git",
    live: "#",
  },
  {
    id: "weather-app",
    title: "Weather App",
    headline: "A simple weather app",
    description:
      "A simple weather app that shows the weather of the current location.",
    client: "Personal Project",
    year: "2024",
    service: "Frontend Development",
    overview: [
    ...
    whatIdid: ["React", "TypeScript", "Tailwind CSS"],
    image: weathAppImage,
    github: "https://github.com/mourice-dev/weath-app-react-tailwindcss.git",
    live: "#",
  },
  {
    ...
    description:
      "A specialized financial calculator for forex traders to compute optimal lot sizes for XAUUSD (Gold) trades based on risk management parameters.",
    client: "Personal Project",
    year: "2025",
